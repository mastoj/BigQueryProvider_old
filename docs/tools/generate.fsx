...
let website = "/BigQueryProvider"

let githubLink = "https://github.com/mastoj/BigQueryProvider"

// Specify more information about your project
let info =
  [ "project-name", "BigQueryProvider"
    "project-author", "Update Author in build.fsx"
    "project-summary", "Project has no summmary; update build.fsx"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/BigQueryProvider" ]
